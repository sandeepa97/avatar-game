...
var rocks =[]
function preload(){
 spriteSheet[0] =  loadImage("assets/img/ang.png");
 spriteSheet[1] = loadImage("assets/img/ang.png");
 spriteSheet[2] = loadImage("assets/img/ang.png");
 spriteSheet[3] = loadImage("assets/img/ang.png");
 spriteSheet[4] = loadImage("assets/img/ang.png");
 spriteSheet[5] = loadImage("assets/img/ang.png");
 spriteSheet[6] = loadImage("assets/img/ang.png");
 spriteSheet[7] = loadImage("assets/img/ang.png");
 jump[4] = loadImage("assets/img/ang2.png");
...
var aud = new Audio("assets/music/music.mp3");
var isPlay = 0;
function song(){
   if(!isPlay) {
       aud.play();
